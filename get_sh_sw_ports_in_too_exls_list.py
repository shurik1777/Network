...
def main():
    ...
    for device_info in devices:
        ...
        connection = switch_manager.establish_connection()
        switch_info_output = switch_manager.get_switch_info(connection)
        connection.disconnect()

        # Получение информации о портах
        connection = switch_manager.establish_connection()
        switch_ports_output = switch_manager.get_switch_ports(connection)
        connection.disconnect()

        # Получение информации о VLAN
        connection = switch_manager.establish_connection()  # Получите информацию о VLAN
        vlan_info_output = switch_manager.get_vlan_info(connection)
        connection.disconnect()
